...
| 11 | Design Eve (controller) | Contract fixed in [platform/wall-e/08-team-eve-mo.md](platform/wall-e/08-team-eve-mo.md); must be observe-only until Wall-E Stage 4 | open | 2026-09-08 |
| 12 | Design Mo (continuous improvement) | Same contract document; no credentials, BigQuery only | open | 2026-09-08 |
