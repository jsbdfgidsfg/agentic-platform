...
|---|---|---|
| Permission lists of `roles/discoveryengine.agentspaceAdmin`, `agentspaceUser`, `editor`, `serviceAgent` | the IAM reference page did not render on 2026-09-13 | read at GE-5; confirm `editor` can register and share (else P56's CI step moves to `ge-admins@`) and whether `viewer` carries `userStores.listUserLicenses` |
