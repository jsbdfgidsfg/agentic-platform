...
- Objective restated 2026-09-13; see the platform HLD
  ([../agentic-platform/01-hld.md](../agentic-platform/01-hld.md) §18 item 5).
...
- Placement updated on 2026-09-13 to the four-project topology (`GEMINI_PROJECT`,
  ...
  (`eve-controller@` halt invoker on `walle-actions-super` — and, decided on the review-findings pass of 2026-09-13, `eve-verifier@` beside it, topology row 27 — the `eve_quality` readers,
...
(`users.get isAdmin` on `walle-actions-super`'s own credential, read-only (corrected 2026-09-13: the band-B lane never holds the narrow token)) — and captures pre-state by the matching `get` or
