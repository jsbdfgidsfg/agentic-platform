...
- Objective restated 2026-09-13; see the platform HLD
  ([../agentic-platform/01-hld.md](../agentic-platform/01-hld.md) §13.3, §18 items 19–24). Mo
  now measures and proposes changes to Eve as well as Wall-E, and Wall-E holds Super Admin; the
  rows this changes are dated below, and one threat row and one residual are added.
...
rather than believing it.** (Qualified 2026-09-13: for numbers about Eve, from `eve_quality`
and `walle_audit` under the source rule, assertion A10 in
[03-metrics-contract.md](03-metrics-contract.md) §7.3, and re-derived by the gate only once
P30's grant exists.) A compromised or hallucinating Mo can write a persuasive
...
Since 2026-09-13 the same holds for Eve: **Eve reads nothing Mo writes**, so a Mo outage leaves
...
Qualified 2026-09-13: Mo may now also propose an Eve threshold change, through
`eve_threshold_tighten` or a gated `eve_threshold_loosen`
([04-artefacts-and-proposals.md](04-artefacts-and-proposals.md) §3.6) — still never the ladder. This
...
Six things this design does not close (R6 added 2026-09-13). None of them is mitigated by another control listed
...
**R6 — Mo improving Eve concentrates authorship on the pilot (added 2026-09-13).** Eve's own
...
| A number about Eve is evidence-eligible without an independent source, or Mo and Eve v0 disagree (added 2026-09-13) | A10 fails the run; A11 sets `metric_divergence` on the Eve scorecard | [03-metrics-contract.md](03-metrics-contract.md) §6, §7.3 |
